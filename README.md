...
Generated with [Bati](https://batijs.dev) ([version 291](https://www.npmjs.com/package/create-bati/v/0.0.291)) using this command:

```sh
bun create bati --react --tailwindcss --shadcn-ui --vercel --biome
```
